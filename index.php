                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <?php if(isset($_SESSION['user_id'])): 
                            ...
                            <?php else: ?>
                                <a href="user/dashboard.php" class="btn btn-outline-light">
        ...
        <div class="container">
            ...
            <div class="dashboard-card">
                <div class="card-header">
                    <h4><i class="fas fa-balance-scale me-2"></i>Revenue vs Expenditure</h4>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    <h5>Services</h5>
                    <ul class="footer-links">
                        <li><a href="#"><i class="fas fa-chevron-right me-2"></i>Tax Calculator</a></li>
                        <li><a href="#"><i class="fas fa-chevron-right me-2"></i>Project Tracking</a></li>
                        <li><a href="#"><i class="fas fa-chevron-right me-2"></i>Budget Reports</a></li>
                        <li><a href="#"><i class="fas fa-chevron-right me-2"></i>Document Downloads</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
                    <h5>Contact Us</h5>
